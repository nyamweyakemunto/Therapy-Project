...
// import { FiCalendar, FiUsers, FiClock, FiDollarSign, FiMessageSquare, FiPieChart } from 'react-icons/fi';
...
//     { id: 1, client: 'Sarah Johnson', time: '10:00 AM', type: 'Video', duration: '50 min', status: 'confirmed' },
//     { id: 2, client: 'Michael Chen', time: '2:30 PM', type: 'In-person', duration: '50 min', status: 'confirmed' },
//     { id: 3, client: 'Emma Williams', time: '4:00 PM', type: 'Phone', duration: '30 min', status: 'pending' }
//   ];

//   const recentClients = [
//     { id: 1, name: 'Jessica Taylor', lastSession: '2 days ago', progress: 75, avatar: 'https://randomuser.me/api/portraits/women/43.jpg' },
//     { id: 2, name: 'David Miller', lastSession: '1 week ago', progress: 60, avatar: 'https://randomuser.me/api/portraits/men/32.jpg' },
//     { id: 3, name: 'Olivia Davis', lastSession: '3 days ago', progress: 85, avatar: 'https://randomuser.me/api/portraits/women/65.jpg' }
//   ];
...
//                 <h3 className="text-2xl font-bold text-gray-800">{stats.pendingSessions}</h3>
//               </div>
//             </div>
//           </motion.div>
...
//                 <h3 className="text-2xl font-bold text-gray-800">{stats.satisfactionRate}%</h3>
//               </div>
//             </div>
//           </motion.div>
//         </div>
...
//                 <FiClock className="mr-2" /> Upcoming Appointments
//               </h2>
//             </div>
//             <div className="p-4">
...
//                 <div
//                   key={appointment.id}
//                   className="flex items-center justify-between p-3 border-b border-gray-100 last:border-0 hover:bg-indigo-50 transition-colors"
//                 >
//                   <div className="flex items-center">
...
//                 </div>
//               ))}
//               <button className="w-full mt-4 py-2 text-indigo-600 hover:text-indigo-800 font-medium flex items-center justify-center">
...
//               <h2 className="text-xl font-semibold flex items-center">
//                 <FiUsers className="mr-2" /> Recent Clients
//               </h2>
//             </div>
//             <div className="p-4">
//               {recentClients.map((client) => (
//                 <div key={client.id} className="flex items-center p-3 border-b border-gray-100 last:border-0 hover:bg-blue-50 transition-colors">
...
//                 </div>
//               ))}
//               <button className="w-full mt-4 py-2 text-blue-600 hover:text-blue-800 font-medium flex items-center justify-center">
//                 View All Clients
//                 <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
//                 </svg>
...
//               <FiPieChart className="mr-2 text-indigo-600" /> Weekly Sessions Overview
//             </h2>
//             <div className="h-64">
